...
export function AuthPage({ mode, nonce }: AuthPageProps) {
  ...
  async function initializeGoogleSignIn() {
    ...
    try {
      ...
      googleNonceRef.current = plainNonce;
        ...
        <div className="w-full max-w-sm">
          ...
          {googleClientId ? (
            <>
              ...
              />
              <div
                className={`relative mt-6 min-h-11 w-full overflow-hidden rounded-md bg-surface ring-1 ring-transparent transition-opacity focus-within:ring-2 focus-within:ring-primary/30 ${
              ...
              >
                ...
                {isGoogleSubmitting && (
                  <div
                    className="absolute inset-0 flex items-center justify-center gap-2 border border-primary/30 bg-primary-light text-sm font-medium text-primary"
                    role="status"
                    aria-live="polite"
                  >
                    <svg
