...
const categories = ["Education", "Environment", "Community", "Food Security", "Health"];
  ...
  return (
    <AppShell header={null}>
      ...
      <div className="mx-auto flex max-w-6xl gap-8 p-6 md:p-8">
        <aside
          className={`${showFilters ? "block" : "hidden"} w-full shrink-0 space-y-6 md:block md:w-64`}
        >
          <Card padding="md">
        ...
        <div className="min-w-0 flex-1">
          <p className="mb-4 text-sm text-text-secondary">
            Showing {filtered.length} grants matching your filters
          </p>
                ...
                <div className="flex flex-col gap-5 lg:flex-row">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-3 text-sm">
                      <span className="font-medium text-text">{grant.amountRange}</span>
                      <span className="text-text-muted">·</span>
                      <Badge variant={getDeadlineVariant(grant.daysLeft)}>
