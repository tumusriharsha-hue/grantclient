...
export function mapGrantRow(row: GrantRow): Grant {
  return {
    ...
    applicationOpenDate: row.application_open_date ?? undefined,
    deadlineType: row.deadline_type as Grant["deadlineType"],
    ...
    funderUrl: row.funder_url ?? undefined,
    secondarySourceUrl: row.secondary_source_url ?? undefined,
    sourceTitle: row.source_title ?? undefined,
    sourcePublishedAt: row.source_published_at ?? undefined,
    verifiedAt: row.verified_at ?? undefined,
    lastVerificationAttempt: row.last_verification_attempt ?? undefined,
    verifiedBy: row.verified_by ?? undefined,
    nextReviewAt: row.next_review_at ?? undefined,
    confidenceLevel: row.confidence_level as Grant["confidenceLevel"],
    invitationOnly: row.invitation_only,
    unsolicitedApplicationsAccepted: row.unsolicited_applications_accepted ?? undefined,
    restrictions: row.restrictions ?? undefined,
    typicalAward: row.typical_award ?? undefined,
    verificationNotes: row.verification_notes ?? undefined,
    previousDeadline: row.previous_deadline ?? undefined,
    lastKnownDeadline: row.last_known_deadline ?? undefined,
    currentCycle: row.current_cycle ?? undefined,
...
export function mapGrantToInsert(grant: Grant): TablesInsert<"grants"> {
  return {
    ...
    region: grant.region,
    status: grant.status,
    is_active: grant.isActive ?? false,
