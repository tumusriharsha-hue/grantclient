...
function createContentSecurityPolicy(nonce: string) {
  ...
  const directives = [
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://*.supabase.co https://accounts.google.com/gsi/ https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com",
    "frame-src 'self' https://*.supabase.co https://accounts.google.com/gsi/",
