...
console.log(JSON.stringify({ ...audit.statusCounts, total: audit.total, deadlinesNext30Days: inWindow(next30), deadlinesNext60Days: inWindow(next60), deadlinesNext90Days: inWindow(next90), requiringReview: audit.requiringReview, duplicateCandidates: audit.duplicateCandidates.length, duplicateUrlCandidates: audit.duplicateUrlCandidates.length }, null, 2));
